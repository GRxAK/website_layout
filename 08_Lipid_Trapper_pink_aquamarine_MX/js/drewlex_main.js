...
//НУЖЕН JQuery! - плавный скролл - элементу даем класс scrollto и пишем href с айди элемента к которому надо скроллить
    if (window.jQuery) {
        $(".scrollto").not('.link').on("click", function (event) {
...
function initFeatures(settings) {
    ...
    if (!settings.formApi || !settings.formApi.isNeeded) {
        var featuresFilesSrc = (window.location.protocol == 'file:') ? {
            userAva: 'src/autoCommentsAva.jpg',
            refreshingArrow: 'src/autoCommentsRefreshing.gif',
            autoCommStyles: 'src/autoComments.css',
            popupsStyles: 'src/popups.css',
            popupsIconUser: 'src/count-user_black.png',
            popupsIconOrder: 'src/count-order-984_black.png',
            prizeWheel: 'src/prizewheel.png',
            wheelCursor: 'src/wheel-cursor.png',
            wheelStyles: 'src/wheel.css',
            formStyles: 'src/formStyles.css'
        } : {
            userAva: 'src/autoCommentsAva.jpg',
            refreshingArrow: 'src/autoCommentsRefreshing.gif',
            autoCommStyles: 'src/autoComments.css',
    ...
    function genLocalForm() {
        var phpsessidInput = document.getElementById('phpsessid');

        if (phpsessidInput != null) {
            action += '?PHPSESSID=' + phpsessidInput.value;
        }
        ...
        var localForms = {
            'en': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Discount!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Make an order before the discount is given to another reader. <br>Offer expires in:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select>  <label for="name" class="data_label">Write your name:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="John Smith"><label for="phone" class="data_label">Write your phone number:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+7 977 777 77 77"> </select> <button class="main-link" type="submit">Buy ' + settings.product + ' with discount 50%!</button> </form> </div><center> <h2 class="time_remains_title">The last day of discount giveaway: <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'en_sg': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Discount!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Make an order before the discount is given to another reader. <br>Offer expires in:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select>  <label for="name" class="data_label">Write your name:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="John Smith"><label for="phone" class="data_label">Write your phone number:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+65 123456789"> </select> <button class="main-link" type="submit">Buy ' + settings.product + ' with discount 50%!</button> </form> </div><center> <h2 class="time_remains_title">The last day of discount giveaway: <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'pt': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">É rentável!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Corra para pedir um desconto até que a oferta seja transferida para o próximo leitor! <br> A oferta ficará inválida em:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Seu nome:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Miguel Castro "><label for="phone" class="data_label">Telefone:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+351.....">  <button class="main-link" type="submit">Encomendar ' + settings.product + ' com 50% de desconto!</button> </form> </div><center> <h2 class="time_remains_title">Oferta válida até (inclusive): <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'ph': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Diskwento!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Umorder na  bago maibigay ang diskwento sa ibang mambabasa.  <br>Ang alok ay matatapos sa loob ng:   <span class="time_remains" id="min">10</span> : <span class="time_remains" id="sec">00</span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Isulat ang pangalan:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Pangalan"><label for="phone" class="data_label">Isulat ang numero ng telepono</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="Telepono"> </select> <button class="main-link" type="submit">Order ' + settings.product + ' na may 50% na diskwento!</button> </form> </div><center> <h2 class="time_remains_title">Ang huling araw ng pagbibigay ng diskwento:  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'mk': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Поволно!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Искористете ја можноста за попуст, дури тоа не му е понудено на наредниот читател! <br> Понудата ќе престане да важи по: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Вашето име:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Јован Ѓорѓиев "><label for="phone" class="data_label">Номер телефона:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+389 70 123 456"> </select> <button class="main-link" type="submit">Нарачај ' + settings.product + ' со попуст 50%!</button> </form> </div><center> <h2 class="time_remains_title">Понудата важи до вклучително): <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'si': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Ugodno je!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Utegnite naročiti po nižji ceni, dokler ni ponudba šla za naslednjega bralca! <br>Ponudba je veljavna do:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Vaše ime:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Jure Slavič"><label for="phone" class="data_label">Telefonska številka:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+7 ......."> </select> <button class="main-link" type="submit">Naročiti ' + settings.product + ' s popustom 50%!</button> </form> </div><center> <h2 class="time_remains_title">Ponudba velja do (vključujoč):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'ru': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Выгодно!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Успейте заказать со скидкой, пока предложение не будет передано следующему читателю! <br>Предложение станет недействительным через:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Ваше имя:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Юрий Петров "><label for="phone" class="data_label">Номер телефона:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+7 977 777 77 77"> </select> <button class="main-link" type="submit">Заказать ' + settings.product + ' со скидкой 50%!</button> </form> </div><center> <h2 class="time_remains_title">Предложение действует до (включительно):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'lt': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Pelninga!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Paskubėkite užsakyti su nuolaida, kol pasiūlymas bus perkeltas į kitą skaitytoją! <br>Pasiūlymas pasibaigs po to, kai:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Jūsų vardas:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Gokhan Karakoc"><label for="phone" class="data_label">Telefono numeris:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+370 123456789"> </select> <button class="main-link" type="submit">UŽSAKYTI ' + settings.product + ' su 50% nuolaida!</button> </form> </div><center> <h2 class="time_remains_title">Pasiūlymas galioja iki (imtinai):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'pl': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Opłacalne!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Pospiesz się, aby zamówić z rabatem, aż oferta zostanie przekazana do następnego czytelnika! <br>Oferta straci ważność po:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Twoje imię i nazwisko:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Tom Czerniak "><label for="phone" class="data_label">Numer telefonu:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+48 123456789"> </select> <button class="main-link" type="submit">ZAMÓWIĆ ' + settings.product + ' z 50% zniżką!</button> </form> </div><center> <h2 class="time_remains_title">Oferta ważna do (włącznie):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'hu': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Nyereséges!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Sietj megrendelésre kedvezménnyel, amíg az ajánlat át nem kerül a következő olvasónak! <br>Az ajánlat érvénytelen lesz, miután:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Az Ön neve:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Tóth Vera "><label for="phone" class="data_label">Telefonszám:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+36 12345678"> </select> <button class="main-link" type="submit">RENDELÉS ' + settings.product + ' kedvezményes áron 50%!</button> </form> </div><center> <h2 class="time_remains_title">Ajánlat (egészen):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',
            'lv': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Izdevīgi!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Pasteidzieties, lai pasūtītu ar atlaidi, līdz piedāvājums tiek nodots nākamajam lasītājam! <br>Piedāvājums kļūs nederīgs pēc:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Jūsu vārds:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder=" Aivars Janis "><label for="phone" class="data_label">Tālruņa numurs:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+371 0123456789"> </select> <button class="main-link" type="submit">PASŪTĪT ' + settings.product + ' ar atlaidi 50%!</button> </form> </div><center> <h2 class="time_remains_title">Piedāvājums ir spēkā līdz (ieskaitot):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',
            'sk': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Ziskový!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Ponáhľajte sa na objednávku so zľavou, kým sa ponuka neprevedie na ďalšiu čitateľku! <br> Ponuka bude neplatná po: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Vaše meno:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Vladimir Gordik "><label for="phone" class="data_label">Telefónne číslo:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+421 123456789"> </select> <button class="main-link" type="submit">Objednať ' + settings.product + ' s 50% zľavou!</button> </form> </div><center> <h2 class="time_remains_title">Ponuka je platná do (vrátane):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'sg': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">贏利！</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">快點訂購，直到優惠轉移到下一位讀者! <br>優惠將在以下情況後失效： <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">你的名字：</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="王心><label for="phone" class="data_label">电话号码:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="电话号码"> </select> <button class="main-link" type="submit">訂購' + settings.product + '享受50％的折扣！</button> </form> </div><center> <h2 class="time_remains_title">優惠有效期至： <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'bg': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Изгодно!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Успейте да поръчате с отстъпка, докато офертата не се предаде на следващия читател! <br>Офертата ще стане невалидна след:   <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Вашето име:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Име"><label for="phone" class="data_label">Телефонен номер:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="Телефон"> </select> <button class="main-link" type="submit">Поръчайте ' + settings.product + ' с 50% отстъпка!</button> </form> </div><center> <h2 class="time_remains_title">Офертата е валидна до (включително):  <span class="time_remains"> ' + outputDat(0, false) + '</span></h2> <br> </center>',

            'hr': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Ovo je korisno!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Požurite na narudžbu uz popust dok se ponuda ne prenese na sljedeći čitatelj! <br>Ponuda će postati nevažeća:   <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Vaše ime:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Ime "><label for="phone" class="data_label">Telefonski broj:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="Telefon"> </select> <button class="main-link" type="submit">Naručiti ' + settings.product + ' popustom 50%!</button> </form> </div><center> <h2 class="time_remains_title">Ponuda vrijedi do (uključivo):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'al': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Çmim i ulët!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Arrini ta porositni me zbritje përpara se oferta ti kalojë një lexuesi tjetër! <br>Oferta do të jetë e pavlefshme pas: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Emri i plote:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Florjan Fejzollari"><label for="phone" class="data_label">Numri i celularit:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="ex: +355 1234567890"> </select> <button class="main-link" type="submit">Porositeni ' + settings.product + ' me një zbritje prej 50%!</button> </form> </div><center> <h2 class="time_remains_title"> Oferta është e vlefshme deri në (përfshirë):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'id': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Menguntungkan!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Punya wakti untuk memesan dengan harga diskon,<br>sampai penawaran akan ditransfer ke pembaca lain!<br>Diskon akan tidak aktif setelah:<br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Masukkan nama:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Nama"><label for="phone" class="data_label">Masukkan nomor telepon:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="Misalnya +62 12345678"> </select> <button class="main-link" type="submit">Beli dengan diskon 50%!</button> </form> </div><center> <h2 class="time_remains_title">Penawaran ini berlaku hingga (inklusif): <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'vn': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"> <span class="discountс">Giảm giá!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Hãy đặt với giá khuyến mãi trước khi ưu đãi này được chuyển qua cho người đọc tiếp theo! Mức giá ưu đãi của bạn sẽ kết thúc sau:<br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Xin hãy nhập tên:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Chung Đình Toản"><label for="phone" class="data_label">Xin hãy nhập số điện thoại:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+84 123456789"> </select> <button class="main-link" type="submit">Đặt hàng ' + settings.product + ' với giảm giá 50%!</button> </form> </div><center> <h2 class="time_remains_title">Xin lưu ý! Chương trình khuyến mãi đặc biệt chỉ có hiệu lực đến hết ngày: <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'it': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"> <span class="discountс">Conveniente!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Affrettatevi a fare l\'ordine prima che lo sconto passi al prossimo lettore, la vostra offerta unica termina tra: <br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Nome e cognome:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Francesco Rossi"><label for="phone" class="data_label">Telefono cellulare:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="Per esempio, +39 0123456789"> </select> <button class="main-link" type="submit">Ordinare ' + settings.product + ' con lo sconto 50%!</button> </form> </div><center> <h2 class="time_remains_title">Ricordate, l\'offerta speciale è valida fino al: <span class="time_remains">' + outputDat(0, false) + '</span> (compreso)</h2> <br> </center>',

            'es': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">DESCUENTO</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Reserve con el precio de promoción antes de que la oferta se pase al siguiente lector! <br>Su tarifa promocional finalizará después de:<br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Nome/Cognome</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Alejandro Rodriguez"><label for="phone" class="data_label">Mob.telefono</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+52 123456789"> </select> <button class="main-link" type="submit">Ordene ' + settings.product + ' con 50% de descuento!</button> </form> </div><center> <h2 class="time_remains_title">EL NÚMERO DE PRODUCTOS DE OFERTA ES LIMITADO. LOS DESCUENTOS TODAVÍA ESTÁN DISPONIBLES <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'co': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">DESCUENTO</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Reserve con el precio de promoción antes de que la oferta se pase al siguiente lector! <br>Su tarifa promocional finalizará después de:<br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Nome/Cognome</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Alejandro Rodriguez"><label for="phone" class="data_label">Mob.telefono</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+57 123456789"> </select> <button class="main-link" type="submit">Ordene ' + settings.product + ' con 50% de descuento!</button> </form> </div><center> <h2 class="time_remains_title">EL NÚMERO DE PRODUCTOS DE OFERTA ES LIMITADO. LOS DESCUENTOS TODAVÍA ESTÁN DISPONIBLES <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'ro': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Reducere!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Cantitatea produsului este limitata, grăbiți-vă să comandați până nu e prea târziu!<br>Reducerea dvs. expiră peste: <br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Introduceți numele dvs </label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Mihai Orbulescu"><label for="phone" class="data_label">Introduceți numarul dvs de telefon </label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+40 123456789"> </select> <button class="main-link" type="submit">COMANDĂ ' + settings.product + '</button> </form> </div><center> <h2 class="time_remains_title">Fiți atenți, oferta este limitată și e valabilă până <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'cz': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Speciální nabídka</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Stíhnete si objednat se slevou, zatím nabídka nepřešla k jinému čtenářovi! <br>Nabídka vyprší za: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Uveďte jméno a příjmení</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Pavel Smejkal"><label for="phone" class="data_label">Uveďte tel.číslo</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+420 123456789"> </select> <button class="main-link" type="submit">OBJEDNAT ' + settings.product + ' SE SLEVOU 50%!</button> </form> </div><center> <h2 class="time_remains_title">Pozor, akce se speciální slevou trvá pouze do  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'th': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">ราคาถูก!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">จนกว่าสินค้าจะสิ้นสุดโปรโมชั่น <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">ชื่อเต็ม </label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="ทวีเดช หยาดทอง"><label for="phone" class="data_label">ใส่หมายเลขโทรศัพท์</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+66 123456789"> </select> <button class="main-link" type="submit">สั่งซื้อ ' + settings.product + ' พร้อมส่วนลด 50%!</button> </form> </div><center> <h2 class="time_remains_title">มองหาโปรโมชั่นด้วยราคาพิเศษ ไม่เกิน - 50%  <span class="time_remains">' + outputDat(0, false) + '</span> (รวมทั้ง)</h2> <br> </center>',

            'gr': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Κερδοφόρα!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Έχετε χρόνο για παραγγελία με έκπτωση, έως ότου η προσφορά μεταφερθεί σε άλλους αναγνώστες! <br>Οι εκπτώσεις θα είναι ανενεργές μετά από: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Εισαγάγετε ένα όνομα</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Πλήρες όνομα"><label for="phone" class="data_label">Εισαγάγετε το τηλέφωνο</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="Τηλέφωνο"> </select> <button class="main-link" type="submit">Αγορά με έκπτωση 50%!</button> </form> </div><center> <h2 class="time_remains_title">Αυτή η προσφορά ισχύει μέχρι (συμπεριλαμβάνεται):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'de': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Rabatt!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Beeilen Sie sich, um die Bestellung mit einem Rabatt abzuschließen, bis das Angebot nicht an einen anderen Leser übergeht! <br>Das Angebot wird ungültig nach:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Name:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Tomas Mann "><label for="phone" class="data_label">Telefonnummer:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+49 151 23456789"> </select> <button class="main-link" type="submit">BESTELLEN ' + settings.product + ' MIT RABATT 50%!</button> </form> </div><center> <h2 class="time_remains_title">Das Angebot gilt bis (einschließlich):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'bg': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Това е изгодно!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Имате време да поръчате това лекарство с отстъпка, докато тази оферта не бъде предадена на други читатели! След това отстъпките ще бъдат деактивирани:<br>  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Въведи име</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="ИМЕ "><label for="phone" class="data_label">Въведи телефонен номер</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="Телефон"> </select> <button class="main-link" type="submit">Вземи с отстъпка от 50%!</button> </form> </div><center> <h2 class="time_remains_title">Тази оферта е валидна до (включително):<span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'fr': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Réduction!</span> <s><span class="js_old_price price_old"><span class="old_price_val"></span> <span class="old_price_cur"></span></span></s><br> <b class="new_price js_new_price price_main"><span class="new_price_val"></span> <span class="new_price_cur"></span></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Dépêchez-vous de faire une commande un rabais, jusqu\'à ce que l\'offre soit transmise à un autre lecteur! <br>L\'offre sera            invalide dans:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form"  method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Nom:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Élise Mercier"><label for="phone" class="data_label">Numéro de téléphone:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+33 6 12 345678"></select> <button class="main-link" type="submit">Commandez ' + settings.product + ' avec 50% de réduction!</button> </form> </div><center> <h2 class="time_remains_title"> L\'offre est valable jusqu\'au (y compris):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>'
        }
