...
// таймер товара 
$(function (){
    let $time = $('.b-quantity-numb').attr('data-time') * 1000;
    setInterval(function(){
        if ($('.b-quantity-numb').html() < 1) {
            return;
        } else {
            let $numb = $('.b-quantity-numb').html();
...
// block5 слайдер
let b_art1 = document.querySelector('.b-art1');
let b_art2 = document.querySelector('.b-art2');
let b_art1Slid = $('.b-art1').find('.b-article');
let b_art2Slid = $('.b-art2').find('.b-article');
let b_art1LeftBtn = $('#b-1-l');
let b_art1RightBtn = $('#b-1-r');
let b_art2LeftBtn = $('#b-2-l');
let b_art2RightBtn = $('#b-2-r');
let b_artWebLeftBtn = $('#b-3-l');
let b_artWebRightBtn = $('#b-3-r');
let b_art1Btn = document.querySelector('.b-zero-btn-1').children;
let b_art2Btn = document.querySelector('.b-zero-btn-2').children;
let b_web_slider = document.querySelectorAll('.b-web-slider');
...
let b_comments = document.querySelector('.b-block9'); 
let b_commentsBtn = document.querySelector('.b-btn-box').children;
let b_commentsSliders = document.querySelectorAll('.b-comment');
...
function b_sliders(block, btn) {
    for (let i=0; i < btn.length; i++) {
        btn[i].addEventListener('click', () => {
            ...
            block[i].classList.add("b-active");
            btn[i].classList.add("b-btn-active");
        });
    }
}
// в лево
...
function b_touchSlider(box, slider, btn) {
    ...
    function TouchEnd(e) {
        if ((touchPositionX < (touchStartX - sensitivity )) && (touchPositionX != null)) {
            ...
            if (box == b_art1) {
                $("html, body").animate({scrollTop: $('.b-block5').find('.b-left').offset().top}, 0);
            } else if (box == b_art2) {
                $("html, body").animate({scrollTop: $('.b-block5').find('.b-right').offset().top}, 0);
            }
...
$(window).scroll(function() {
  ...
  var offset = $element.offset().top
    ...
    if (scroll > offset && counter == 0) {
        ...
        setTimeout(()=>{$element.find('.b-artline-1').addClass("a-b5-3");}, 2000);
        setTimeout(()=>{$element.find('.b-artline-2').addClass("a-b5-3");}, 2000);
        setTimeout(()=>{$element.find('.b-artline-3').addClass("a-b5-3");}, 2000);
        setTimeout(()=>{$element.find('.b-artline-4').addClass("a-b5-3");}, 2000);
        setTimeout(()=>{$element.find('.b-article-img').addClass("a-b5-3");}, 2000);
        setTimeout(()=>{$element.find('.b-article-text').addClass("a-b5-3");}, 2000);
        setTimeout(()=>{$element.find('.b-artline-5').addClass("a-b5-line-up-21");}, 2000);
        setTimeout(()=>{$element.find('.b-1').find('.b-artline-6').addClass("a-b5-line-left-22");}, 2000);
        setTimeout(()=>{$element.find('.b-2').find('.b-artline-6').addClass("a-b5-line-right-22");}, 2000);
        counter = 1;
        }
    });
});
...
// B-7
$(document).ready(function(){   
    let $element = $('.b-block7');
    let counter = 0;
    // let $text3 = $element.find('.t-3').text();
    // let $text4 = $element.find('.t-4').text();
    // let $text5 = $element.find('.t-5').text();
    // let $text6 = $element.find('.t-6').text();
    // let $text7 = $element.find('.t-7').text();
...
$(window).scroll(function() {
  ...
  var offset = $element.offset().top
    ...
    if (scroll > offset && counter == 0) {
        ...
        // (async function main() {
        //     let str = "Предложение";
        //     await printer(".t-3", $text3);
        //     await printer(".t-4", $text4);
        //     await printer(".t-5", $text5);
        //     await printer(".t-6", $text6);
        //     await printer(".t-7", $text7);
        //     await $('.b-autograph').css('opacity', '1');
        // })();
        // // end
        counter = 1;
        }
